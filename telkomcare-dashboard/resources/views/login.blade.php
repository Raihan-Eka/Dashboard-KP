...
<head>
    ...
    <style>
        ...
        /* PERBAIKAN: Style untuk pembungkus logo */
        .logo-wrapper {
            background-color: #F1F5F9; /* Warna abu-abu sangat muda */
            display: inline-block; /* Agar background pas dengan isi */
            padding: 1rem; /* Jarak antara logo dan background */
        ...
        .logo {
            width: 150px;
            display: block; /* Agar tidak ada spasi ekstra di bawah gambar */
        }
...
<body>
    ...
    <div class="login-container">
        <!-- PERBAIKAN: Logo dibungkus dengan div untuk background -->
        <div class="logo-wrapper">
            <img src="{{ asset('images/logo.svg') }}" alt="Logo TelkomCare" class="logo">
        </div>
